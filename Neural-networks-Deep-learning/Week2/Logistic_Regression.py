...
# Reshape the training and
# test data sets so that images of
#size (num_px, num_px, 3) are flattened into
...
#you can do the "forward" and "backward" propagation steps for
...
#Interpretation:
#You can see the cost decreasing.
